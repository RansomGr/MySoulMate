...
//            Fields.put(description_ta,"description");
    ...
    private void add_new_plan(ActionEvent event) throws SQLException {
        ...
        {
       if( Gp.create(new Plan((type_cb.getValue()),email_tf.getText(),siteweb_tf.getText(),photo_img.getText(),Integer.parseInt(telephone_tf.getText()),description_ta.getText(),nom_tf.getText()))==1)
       {
        ...
        else
        {
               Optional<ButtonType> result = ConfirmWindow.showAndWait();
                     ...
                     {   
                       if( Gp.update(new Plan((type_cb.getValue()),email_tf.getText(),siteweb_tf.getText(),photo_img.getText(),Integer.parseInt(telephone_tf.getText()),description_ta.getText(),nom_tf.getText()))==1)
                       {System.out.println("modifiing ....");
                           InformationWindow.setContentText("Plan modifié avec succée !");
                           InformationWindow.show();
                           OperationMode="Ajouter";
                           Plan_to_be_modified=new Plan(Plan_to_be_modified.getId(),(type_cb.getValue()),email_tf.getText(),siteweb_tf.getText(),photo_img.getText(),Integer.parseInt(telephone_tf.getText()),description_ta.getText(),nom_tf.getText());
                       }
                       else
                          ErrorWindow.show();   
                     }
