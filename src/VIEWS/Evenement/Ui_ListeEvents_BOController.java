 ...
 * @author dellpro
 */
public class Ui_ListeEvents_BOController implements Initializable {
            ...
            row.setOnMouseClicked(e -> {
             if (e.getClickCount() == 2 && (!row.isEmpty()) ) {
                 ...
                 try {
                     ...
                     Logger.getLogger(Ui_ListeEvents_BOController.class.getName()).log(Level.SEVERE, null, ex);
                 }
                 }
                 });
                return row;
    ...
    {
     Ui_MainFrame_BOController.Update_Event_request();
