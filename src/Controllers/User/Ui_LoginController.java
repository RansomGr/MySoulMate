 ...
 * @author Ransom
 */
public class Ui_LoginController implements Initializable {
    ...
    private void Forgot_page(ActionEvent event) throws IOException
    {
     ...
     Parent root = FXMLLoader.load(getClass().getResource("/VIEWS/User/ui_Forgot.fxml"));
    ...
    {
     Stage PrimaryStage=MySoulMate.getMainStage();
     Parent root = FXMLLoader.load(getClass().getResource("/VIEWS/User/ui_Dash_login.fxml"));
     Scene scene = new Scene(root);
     PrimaryStage.setScene(scene);
     PrimaryStage.show();
    }
    ...
    {
     Stage PrimaryStage=MySoulMate.getMainStage();
     Parent root = FXMLLoader.load(getClass().getResource("/VIEWS/User/ui_Create_new.fxml"));
     Scene scene = new Scene(root);
     PrimaryStage.setScene(scene);
     PrimaryStage.show();
    }
