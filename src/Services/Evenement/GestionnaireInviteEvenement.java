 ...
 * @author dellpro
 */
public class GestionnaireInviteEvenement implements Gestionnaire{
    ...
    public int create(Object o) throws SQLException {
      ...
      pst.setInt(1, ivtevt.getClt().getID());
      pst.setInt(2,ivtevt.getEvtgroup().getID());
    ...
    public List<? extends Object> fetchAll() throws SQLException {
       String query=" select * from invite_evenement  "    ; // preparation du requete sql
          ...
          while(res.next())// parcour du result set
          {
              ...
              EvenementGroup evt = events.stream().filter(e1->e1.getID()==Event_ID_in_question).findFirst().get();
